                    ...
                    <div class="col-xs-6 col-xs-offset-3">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                               <h1 class="entry-title">Logga in      <a  href="adminlogin.php" style="padding-left: 700px;vertical-align: middle" >ADMIN? </a>  </h1>
                            </div>
                            <div class="panel-body">
                                <p>Logga in för att göra ett köp</p>
                                <form class="wpcf7" method="post" action="login_submit.php" id="contactform">
